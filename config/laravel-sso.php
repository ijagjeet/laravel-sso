...
return [
    ...
    'brokersModel' => IJagjeet\LaravelSSO\Models\Broker::class,
    'brokersUserModel' => IJagjeet\LaravelSSO\Models\BrokerUser::class,

    // Table used in IJagjeet\LaravelSSO\Models\Broker model
